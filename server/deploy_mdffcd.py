...
# Final Stealth Space Credentials (mdffcd)
token = "os.getenv("HF_TOKEN")"
repo_id = "monakoki/mdffcd" 

api = HfApi(token=token)

print(f"--- Deploying Stealth AI to: {repo_id} ---")
try:
...
if os.path.exists(dockerfile_path):
    ...
    lines.append(f"\n# BUILD_TRIGGER_MDFFCD: {time.time()}\n")
    
    with open(dockerfile_path, "w") as f:
        f.writelines(lines)
    print("Added Build Trigger for 'mdffcd' to Dockerfile.")

print("Uploading stealth system files...")
