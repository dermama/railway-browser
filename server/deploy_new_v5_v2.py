...
# Final Credentials (V5 Pro V2)
token = "os.getenv("HF_TOKEN")"
repo_id = "monldds/fashion-ai-v5-pro-v2" 

api = HfApi(token=token)

print(f"Targeting repository: {repo_id}...")
# Repository was created manually by the user.
...
try:
    ...
    print(f"Successfully deployed to V2: https://huggingface.co/spaces/{repo_id}")
